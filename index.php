...
<body>
      ...
      <div class="container mt-3">
        <div class="row d-flex justify-content-start align-items-start main-container">
          <div class="col-md-5 col-sm-12 col-lg-5 reveal main-text mb-4 text-align-justify mt-5" data-aos="fade-up">
            <h2>Welcome to <span style="color: #fb4a36;"> SmartCart,</span></h2>
            ...
            <p style="font-size: 18px; text-align: justify;">
              ...
              flavor. At SmartCart, we believe in making every meal an
      ...
      <div class="container ">
        ...
        <div class="story-content row mb-2">
          <div class="story-text col-lg-6 col-md-6 col-sm-12 reveal mt-2" data-aos="fade-up" data-os-interval="300">
            <p>At <strong>SmartCart</strong>, we are passionate about celebrating food. Our chefs bring a touch of creativity to every dish, ensuring a feast for your senses. Join us for an extraordinary dining experience that celebrates flavor and joy.</p>
            <p>Founded in [2025], SmartCart has been at the forefront of culinary innovation. Our commitment to using the freshest ingredients, combined with our chefs' expertise, has earned us a reputation for excellence. We believe that dining is not just about eating; it's about experiencing the art of food.</p>
            <p>Whether you're looking for a romantic dinner, a family gathering, or a place to celebrate special occasions, SmartCart offers the perfect ambiance and exquisite cuisine to make your visit unforgettable. Come and experience the joy of flavor with us!</p>
  ...
  <!-- Review  -->
<!-- one more review -->
<section class="insta-review-section" id="review">
    <div class="insta-review-container">
        <h2 class="insta-review-title">Client Love ❤️</h2>
        <div class="insta-review-grid">
            <?php
            include 'db_connection.php';
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "
                    <div class='insta-review-card'>
                        <div class='insta-user-info'>
                            <img src='uploads/default.jpg' class='insta-profile-pic' alt='User'>
                            <span class='insta-username'>{$row['email']}</span>
                        </div>
                        <div class='insta-review-stars'>{$stars}</div>
                        <p class='insta-review-text'>\"{$row['review_text']}\"</p>
                        <div class='insta-owner-reply'>
                            <p>\"{$row['response']}\"</p>
                            <span>- Owner</span>
                        </div>
                    </div>";
    ...
    <div class="footer-container">
      <div class="footer-row">
        <div class="footer-col" id="contact">
          <h4>Contact Us</h4>
          <p>Shastri circle,Kundpura</p>
          <p>Email: lohitmdevadiga11@gmail.com</p>
          <p>Phone: +91 9110258470</p>
        </div>
      ...
      <div class="footer-bottom">
        <h4>&copy; 2025 Authored by Lohit Devadiga. All Rights Reserved.</h4>
      </div>
    </div>
  </footer>
